...
#     self.G_new_sum = histogram_summary("G_new", self.G_new)
    ...
    self.walk_loss = tf.losses.compute_weighted_loss(tf.square(self.G_new - self.target), weights=self.mask)
    ######
...
#     self.g_loss = self.g_loss + self.g_loss_new
    self.g_loss = self.g_loss + self.g_loss_new  + self.walk_loss
    ######
